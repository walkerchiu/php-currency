...
class CurrencyLangTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testCurrencyLang()
    {
        ...
        $db_lang_1 = factory(CurrencyLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = factory(CurrencyLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'description']);
        $db_lang_3 = factory(CurrencyLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'zh_tw', 'key' => 'description']);
        $db_lang_4 = factory(CurrencyLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_5 = factory(CurrencyLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_6 = factory(CurrencyLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Currency::class, 'code' => 'zh_tw', 'key' => 'description']);
        ...
        // Get record's morph
            // When
            $record = CurrencyLang::find($db_lang_1->id);
            // Then
    ...
    public function testCurrency()
    {
        ...
        // Get lang of record
            // When
            $record_1 = Currency::find($db_morph_1->id);
            $lang_1   = CurrencyLang::find($db_lang_1->id);
            $lang_4   = CurrencyLang::find($db_lang_4->id);
            // Then
        ...
        // Get lang's histories of record
            ...
            $record_2 = Currency::find($db_morph_2->id);
