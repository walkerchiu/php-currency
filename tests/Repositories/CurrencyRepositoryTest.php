...
use WalkerChiu\Currency\Models\Repositories\CurrencyRepository;

class CurrencyRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->app->make(CurrencyRepository::class);
    }
    ...
    /**
     * A basic functional test on CurrencyRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testCurrencyRepository()
    {
        // Config
    ...
    /**
     * Unit test about Lang creation on CurrencyRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\Currency\Models\Repositories\CurrencyRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(CurrencyLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on CurrencyRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\Currency\Models\Repositories\CurrencyRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        $db_morph_1 = factory(Currency::class)->create(['is_enabled' => 1]);
        $db_morph_2 = factory(Currency::class)->create();
        $db_morph_3 = factory(Currency::class)->create();
        $db_morph_4 = factory(Currency::class)->create();
    ...
    /**
     * Unit test about Query List on CurrencyRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\Currency\Models\Repositories\CurrencyRepository
     *
    ...
    public function testQueryList()
    {
        ...
        // Give
        $db_morph_1 = factory(Currency::class)->create();
        $db_morph_2 = factory(Currency::class)->create();
        $db_morph_3 = factory(Currency::class)->create();
        $db_morph_4 = factory(Currency::class)->create();
    ...
    /**
     * Unit test about FormTrait on CurrencyRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\Currency\Models\Repositories\CurrencyRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $db_morph_1 = factory(Currency::class)->create();
            $db_morph_2 = factory(Currency::class)->create();
            $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Currency::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(Currency::class)->create(['serial' => '123']);
            $db_morph_4 = factory(Currency::class)->create(['serial' => '124']);
            $db_morph_5 = factory(Currency::class)->create(['serial' => '125', 'is_enabled' => 1]);
            // When
    ...
    /**
     * Unit test about Auto Complete on CurrencyRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\Currency\Models\Repositories\CurrencyRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        $db_morph_1 = factory(Currency::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        $db_morph_2 = factory(Currency::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Currency::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
