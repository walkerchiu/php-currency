    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (isset($data['host_type']) && isset($data['host_id'])) {
                if ( config('wk-currency.onoff.site') && !empty(config('wk-core.class.site.site')) && $data['host_type'] == config('wk-core.class.site.site') ) {
                ...
                } elseif ( config('wk-currency.onoff.group') && !empty(config('wk-core.class.group.group')) && $data['host_type'] == config('wk-core.class.group.group') ) {
            ...
            if (isset($data['is_base']) && isset($data['is_enabled'])) {
                if ($data['is_base'] && $data['is_enabled'] == 0)
